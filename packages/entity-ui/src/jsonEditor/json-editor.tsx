...
export const jsonEditorComponentSchema = defineComponentSchema<EntityJsonEditorProps>({
  kind: "component",
  name: entityReactComponentNames.EntityJsonEditor,
  component: EntityJsonEditor
});

export const jsonEditorFieldSchema = defineFieldSchema<EntityJsonEditorProps>({
  kind: "field",
